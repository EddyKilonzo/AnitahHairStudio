...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    if (!ctn.offsetWidth || !ctn.offsetHeight) {
    ...
    function resize() {
      if (!ctn) return;
      const width = window.innerWidth || ctn.offsetWidth || 1920;
      const height = window.innerHeight || ctn.offsetHeight || 1080;
    ...
    const update = (t: number) => {
      ...
      const currentSpeed = currentProps.speed ?? speed;

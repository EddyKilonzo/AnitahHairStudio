          ...
          >
            ...
            >
              <a 
                ...
                onClick={addHeroRipple}
                className="inline-flex items-center justify-center px-3 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-2.5 lg:px-8 lg:py-4 rounded-full border-2 border-primary bg-transparent text-primary font-semibold hover:shadow-xl hover:scale-105 hover:bg-primary/10 transition-all duration-300 text-[10px] sm:text-xs md:text-sm lg:text-lg relative overflow-hidden"
              >
                <span className="relative z-10">Book Appointment</span>
                {heroRipples.length > 0 && (
                ...
                {services.map((service, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                    <Icon 
                      className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 transition-all duration-300 group-hover:scale-125 group-hover:rotate-12" 
                      style={{ 
                        color: service.color
                      }}
                    />
                      ...
                      {/* Service Label */}
                      <span 
                        className={`text-[10px] sm:text-xs md:text-sm font-medium transition-all duration-300 text-center ${
                          hasFocus && !isFocused 
                            ? 'text-foreground/40 blur-sm' 
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Icon 
                      className="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 transition-all duration-300 group-hover:scale-125 group-hover:rotate-12" 
                      style={{ 
                        color: service.color
                      }}
                    />
                  ...
                  {/* Service Label */}
                  <span 
                    className={`text-[10px] lg:text-xs xl:text-sm font-medium transition-all duration-300 text-center ${
                      hasFocus && !isFocused 
                        ? 'text-foreground/40 blur-sm' 
                        : 'text-foreground/70 group-hover:text-foreground'
                    }`}

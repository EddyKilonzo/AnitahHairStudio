            ...
            <div className="border-t border-white/10 pt-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 text-white font-medium min-h-[52px] active:scale-95 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/50 hover:scale-105"
                >
